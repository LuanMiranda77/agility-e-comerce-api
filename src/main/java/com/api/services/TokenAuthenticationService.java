...
public class TokenAuthenticationService {
	...
	// EXPIRATION_TIME = 1 hora de 
		...
		/*
		 * static Authentication getAuthentication(HttpServletRequest request) { String
		 * token = request.getHeader(HEADER_STRING);
		 * 
		 * if (token != null) { // faz parse do token String user = Jwts.parser()
		 ...
		 * null, Collections.emptyList()); } } return null; }
		 */
